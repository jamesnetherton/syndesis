...
echo "$MESSAGE" > ${extrasdir}/syndesis-monitoring.yml
go run extras/syndesis-extras-template.go >> ${extrasdir}/syndesis-monitoring.yml
# go run extras/syndesis-extras-template.go
